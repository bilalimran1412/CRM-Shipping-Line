...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('logistic', '0004_vehicle_status'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='HistoricalLogisticConfig',
            fields=[
                ...
                ('initial_status', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='logistic.deliverystatus')),
            ...
            options={
                'verbose_name': 'historical logistic config',
                'verbose_name_plural': 'historical logistic configs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_status', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='logistic.deliverystatus')),
