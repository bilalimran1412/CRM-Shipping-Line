    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=core.utils.files.FilePath('user/{id}/photo'))),
            ...
            managers=[
                ('objects', user.querysets.user.UsersManager()),
            ],
        ),
        migrations.CreateModel(
            name='GroupExtension',
