      ...
      >
        ...
        >
          <Typography variant="subtitle1" sx={{ flexGrow: 1 }}>
            {translate('configurator.title')}
          </Typography>

          <Tooltip title={translate('configurator.reset')}>
        ...
        <Scrollbar sx={{ p: SPACING, pb: 0 }}>
          <Block title={translate('configurator.mode')}>
            <ModeOptions />
          </Block>

          <Block title={translate('configurator.contrast')}>
            <ContrastOptions />
          </Block>

          <Block title={translate('configurator.direction')}>
            <DirectionOptions />
          </Block>

          <Block title={translate('configurator.layout')}>
            <LayoutOptions />
          </Block>

          <Block title={translate('configurator.stretch')} tooltip={translate('configurator.stretch_desc')}>
            <StretchOptions />
          </Block>

          <Block title={translate('configurator.presets')}>
            <ColorPresetsOptions />
          </Block>
        </Scrollbar>
