...
export default function UserEditPage() {
  ...
  const onSubmit = values => {
    ...
    updateData(id, data, {
      success: data => {
        enqueueSnackbar(translate('group.success.edit'), {
          variant: 'success',
      ...
      error: e => {
        enqueueSnackbar(translate('group.error.edit'), {
          variant: 'error',
          autoHideDuration: 5 * 1000
        })
      }
