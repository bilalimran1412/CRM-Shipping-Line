                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('group.form.title')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.title}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('group.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
