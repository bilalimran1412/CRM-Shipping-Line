...
export default function UserEditPage() {
  ...
  const onSubmit = values => {
    ...
    updateData(id, data, {
      success: data => {
        enqueueSnackbar(translate('user.success.edit'), {
          variant: 'success',
      ...
      error: e => {
        enqueueSnackbar(translate('user.error.edit'), {
          variant: 'error',
          autoHideDuration: 5 * 1000
        })
      }
