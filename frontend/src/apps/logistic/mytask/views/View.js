                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.task_type')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.datetime')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.datetime}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.status')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.status}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.note')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.note}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('my-vehicle-task.form.assigned_to')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
