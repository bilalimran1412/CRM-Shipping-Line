...
export default function View() {
  ...
  return (
    <>
      <Helmet>
        <title>{translate('shipment-type.title.view')}</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        <CustomBreadcrumbs
          heading={translate('shipment-type.title.view')}
          links={[
            ...
            {name: translate('shipment-type.breadcrumb.view')},
          ]}
        />
                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('shipment-type.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
