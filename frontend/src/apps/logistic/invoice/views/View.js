                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('invoice.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
