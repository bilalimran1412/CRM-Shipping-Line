...
export default function UserEditPage() {
  ...
  const onSubmit = values => {
    ...
    updateData(id, data, {
      success: data => {
        enqueueSnackbar(translate('vehicle-photo-category.success.edit'), {
          variant: 'success',
      ...
      error: e => {
        enqueueSnackbar(translate('vehicle-photo-category.error.edit'), {
          variant: 'error',
          autoHideDuration: 5 * 1000
        })
      }
  ...
  return (
    <>
      <Helmet>
        <title>{translate('vehicle-photo-category.title.edit')}</title>
      </Helmet>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        ...
        <CustomBreadcrumbs
          heading={translate('vehicle-photo-category.title.edit')}
          links={[
            ...
            {name: translate('vehicle-photo-category.breadcrumb.edit')},
          ]}
        />
