...
export default function View() {
  ...
  return (
    <>
      <Helmet>
        <title>{translate('vehicle-photo-category.title.view')}</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        <CustomBreadcrumbs
          heading={translate('vehicle-photo-category.title.view')}
          links={[
            ...
            {name: translate('vehicle-photo-category.breadcrumb.view')},
          ]}
        />
                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle-photo-category.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
