...
import EditForm from "../components/TaskEditForm";
...
export default function View() {
  ...
  return (
    <>
      <Helmet>
        <title>{translate('vehicle_task.title.view')}</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        <CustomBreadcrumbs
          heading={translate('vehicle_task.title.view')}
          links={[
            {name: translate('breadcrumb.main'), href: MAIN_NAVIGATION_ROOT},
            {name: translate('vehicle_task.breadcrumb.main'), href: LIST_NAVIGATION},
            {name: translate('vehicle_task.breadcrumb.view')},
          ]}
        />
                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.task_type')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.datetime')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.datetime}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.status')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.status}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.note')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.note}
                          </Typography>
                      ...
                      <TableRow>
                        <TableCell>{translate('vehicle_task.form.assigned_to')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.assigned_to.map(user => user.full_name).join(', ')}
                          </Typography>
                        </TableCell>
                      </TableRow>
                    </TableBody>
