...
const en = {
  title: {
    page: 'Shipment companies',
    navigation: 'Shipment companies',
    list: 'Shipment companies',
    edit: 'Edit shipment company',
    create: 'New shipment company',
    view: 'View shipment company',
  },
  create: 'Add',
  form: {
    main_data: 'Main Data',
