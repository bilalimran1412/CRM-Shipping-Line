...
export default function UserEditPage() {
  ...
  const onSubmit = values => {
    ...
    updateData(id, data, {
      success: data => {
        enqueueSnackbar(translate('shipment.success.edit'), {
          variant: 'success',
      ...
      error: e => {
        enqueueSnackbar(translate('shipment.error.edit'), {
          variant: 'error',
          autoHideDuration: 5 * 1000
        })
      }
  ...
  return (
    <>
      <Helmet>
        <title>{translate('shipment.title.edit')}</title>
      </Helmet>
