...
const ru = {
  title: {
    page: 'Инвойсы клиентов',
    navigation: 'Инвойсы клиентов',
    list: 'Инвойсы клиентов',
    edit: 'Редактирование инвойса клиента',
    create: 'Новый инвойс клиента',
    view: 'Просмотр инвойса клиента',
  },
  create: 'Добавить',
  templates: 'Шаблоны',
  pcs: 'шт.',
  form: {
    ...
    header_footer_data: 'Шапка и подвал инвойса',
    templates: 'Шаблоны',
  ...
  validator: {
    ...
    template_required: 'Шаблон обязателен',
  ...
  error: {
    ...
    download: 'Произошла ошибка при скачивании инвойса',
  },
  success: {
