...
export default function View() {
  ...
  return (
    <>
      <Helmet>
        <title>{translate('customer-invoice.title.view')}</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        <CustomBreadcrumbs
          heading={translate('customer-invoice.title.view')}
          links={[
            ...
            {name: translate('customer-invoice.breadcrumb.view')},
          ]}
        />
                ...
                <Scrollbar>
                  <Table size={'small'}>
                    ...
                    <TableBody className={themeMode === 'dark' ? 'dark' : 'light'}>
                      ...
                      <TableRow>
                        <TableCell>{translate('customer-invoice.form.name')}</TableCell>
                        <TableCell>
                          <Typography variant="subtitle2">
                            {detail.name}
                          </Typography>
