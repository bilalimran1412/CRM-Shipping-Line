...
export default function UserEditPage() {
  ...
  const onSubmit = values => {
    ...
    updateData(id, data, {
      success: data => {
        enqueueSnackbar(translate('customer-invoice-detail-template.success.edit'), {
          variant: 'success',
      ...
      error: e => {
        enqueueSnackbar(translate('customer-invoice-detail-template.error.edit'), {
          variant: 'error',
          autoHideDuration: 5 * 1000
        })
      }
  ...
  return (
    <>
      <Helmet>
        <title>{translate('customer-invoice-detail-template.title.edit')}</title>
      </Helmet>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'} className='relative-block'>
        ...
        <CustomBreadcrumbs
          heading={translate('customer-invoice-detail-template.title.edit')}
          links={[
            ...
            {name: translate('customer-invoice-detail-template.breadcrumb.edit')},
          ]}
        />
